...
public class PropertiesConfigurer {
	...
	public Properties properties() throws IOException {
		...
		Resource[] resources = {
				...
				resolver.getResource("classpath:conf/lucene/lucene_" + AppConfig.getEvnName() + ".properties"),
				resolver.getResource("classpath:conf/userProfile/MerakVip_" + AppConfig.getEvnName() + ".properties"),
				resolver.getResource("classpath:conf/sms/sms_" + AppConfig.getEvnName() + ".properties"),
				resolver.getResource("classpath:conf/userProfile/RecommendCode_" + AppConfig.getEvnName() + ".properties")
				};
